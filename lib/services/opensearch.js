...
ALY.OpenSearch = ALY.Service.defineService('opensearch', ['2015-01-01'], {
  ...
  buildContent: function buildContent(req) {
    ...
    var params = {};
    // if(req.params && req.params.items && req.params.items[0] && req.params.items[0].fields) {
    //   let docObj = req.params.items[0].fields
    //   Object.keys(docObj).forEach(e => {
    //     try{
    //       if(typeof docObj[e] === 'string') {
    //         let testObj = JSON.parse(docObj[e])
